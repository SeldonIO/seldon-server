...
class iNNEDetector(BaseAnomalyDetection):
    ...
    def get_score(self,y,decision_threshold=0.5):
        """ 
    ...
    def get_anomalies(self,decision_threshold=0.5):
        """
        ...
        if 'X_scored' in dir(self):
            ...
            X_an = X[scores>decision_threshold]
            anom_scores = scores[scores>decision_threshold]
            self.X_anom = np.column_stack((X_an,anom_scores))
