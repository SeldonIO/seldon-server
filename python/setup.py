...
setup(name='seldon',
      ...
      install_requires=['wabbit_wappa==3.0.2','xgboost','kazoo','scikit-learn>=0.17','scipy','numpy','boto','filechunkio','keras','tensorflow','pylibmc', 'annoy', 'gensim', "Flask", "pandas>=0.17", "cmd2", "MySQL-python", "smart_open", "luigi"],
      dependency_links = [
