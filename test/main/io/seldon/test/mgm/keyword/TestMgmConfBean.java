...
public class TestMgmConfBean {
	...
	public void jsonTest() throws JsonGenerationException, JsonMappingException, IOException
	{
		...
		String r = mapper.writeValueAsString(b);
		System.out.println(r);
		
		MgmKeywordConfBean b2 = mapper.readValue(r, MgmKeywordConfBean.class);
		
		Assert.assertEquals(b.getClientToLanguages().size(), b2.getClientToLanguages().size());
	}
