...
import io.seldon.api.state.ClientAlgorithmStore.Strategy;
...
private static Logger logger = Logger.getLogger(StrategyDeserializer.class.getName());
    StrategyDeserializer() {
        super(Strategy.class);
        registerStrategyType("variations", ClientAlgorithmStore.TestConfig.class);
        registerStrategyType("algorithms",ClientAlgorithmStore.AlgorithmConfig.class);
    }
