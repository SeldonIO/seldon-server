...
public class ScoreDivImpressionDecayFunction implements  SocialFriendsScoreDecayFunction
{
    ...
    public ScoreDivImpressionDecayFunction(Double impressionDecayRate)
    {
